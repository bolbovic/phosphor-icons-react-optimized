...
const V = H((r, a) => {
  ...
  return /* @__PURE__ */ d.createElement(R, s({ ref: a }, t), e, /* @__PURE__ */ d.createElement("path", { d: "M216,40H40A16,16,0,0,0,24,56V200a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A16,16,0,0,0,216,40Zm0,160H40V56H216V200Z" }));
});
