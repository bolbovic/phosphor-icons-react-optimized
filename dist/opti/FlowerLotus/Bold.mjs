...
var r = (a, c, e) => c in a ? s(a, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[c] = e, Z = (a, c) => {
  for (var e in c || (c = {}))
    p.call(c, e) && r(a, e, c[e]);
  if (m)
    for (var e of m(c))
      C.call(c, e) && r(a, e, c[e]);
  return a;
};
var d = (a, c) => {
  var e = {};
  ...
  if (a != null && m)
    for (var t of m(a))
      c.indexOf(t) < 0 && C.call(a, t) && (e[t] = a[t]);
  return e;
};
