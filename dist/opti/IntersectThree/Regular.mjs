...
var c = (a, A, e) => A in a ? s(a, A, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[A] = e, l = (a, A) => {
  for (var e in A || (A = {}))
    Z.call(A, e) && c(a, e, A[e]);
  if (r)
    for (var e of r(A))
