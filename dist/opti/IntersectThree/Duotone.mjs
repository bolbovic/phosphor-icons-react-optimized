...
var c = (a, A, e) => A in a ? i(a, A, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[A] = e, n = (a, A) => {
  for (var e in A || (A = {}))
    r.call(A, e) && c(a, e, A[e]);
  if (m)
    for (var e of m(A))
      p.call(A, e) && c(a, e, A[e]);
  return a;
};
var M = (a, A) => {
  var e = {};
  for (var t in a)
    r.call(a, t) && A.indexOf(t) < 0 && (e[t] = a[t]);
  if (a != null && m)
    for (var t of m(a))
      A.indexOf(t) < 0 && p.call(a, t) && (e[t] = a[t]);
  return e;
};
import o, { forwardRef as d } from "react";
import f from "../../lib/OptiBase.mjs";
const l = d((t, e) => {
  var Z = t, { children: a } = Z, A = M(Z, ["children"]);
  return /* @__PURE__ */ o.createElement(f, n({ ref: e }, A), a, /* @__PURE__ */ o.createElement(
    "path",
    {
