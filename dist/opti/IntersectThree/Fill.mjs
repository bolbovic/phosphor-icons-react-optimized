...
var c = (a, A, e) => A in a ? M(a, A, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[A] = e, Z = (a, A) => {
  for (var e in A || (A = {}))
    l.call(A, e) && c(a, e, A[e]);
  if (m)
    for (var e of m(A))
