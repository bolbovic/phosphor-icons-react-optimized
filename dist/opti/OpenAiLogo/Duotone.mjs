...
var r = (a, l, e) => l in a ? n(a, l, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[l] = e, m = (a, l) => {
  for (var e in l || (l = {}))
...
const i = L((t, e) => {
  var Z = t, { children: a } = Z, l = p(Z, ["children"]);
  return /* @__PURE__ */ c.createElement(V, m({ ref: e }, l), a, /* @__PURE__ */ c.createElement(
    "path",
    {
