...
var l = (a, e, c) => e in a ? Z(a, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[e] = c, p = (a, e) => {
  for (var c in e || (e = {}))
    o.call(e, c) && l(a, c, e[c]);
  if (m)
    for (var c of m(e))
      i.call(e, c) && l(a, c, e[c]);
  return a;
};
var A = (a, e) => {
  var c = {};
