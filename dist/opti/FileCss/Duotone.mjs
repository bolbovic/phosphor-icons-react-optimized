...
var p = (a, c, e) => c in a ? s(a, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[c] = e, i = (a, c) => {
  for (var e in c || (c = {}))
    n.call(c, e) && p(a, e, c[e]);
  if (o)
    for (var e of o(c))
      Z.call(c, e) && p(a, e, c[e]);
  return a;
};
var l = (a, c) => {
  var e = {};
  for (var t in a)
    n.call(a, t) && c.indexOf(t) < 0 && (e[t] = a[t]);
  if (a != null && o)
    for (var t of o(a))
      c.indexOf(t) < 0 && Z.call(a, t) && (e[t] = a[t]);
  return e;
};
