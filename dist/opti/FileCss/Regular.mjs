...
var A = (a, e) => {
  var c = {};
  for (var r in a)
    l.call(a, r) && e.indexOf(r) < 0 && (c[r] = a[r]);
  if (a != null && t)
    for (var r of t(a))
      e.indexOf(r) < 0 && p.call(a, r) && (c[r] = a[r]);
  return c;
};
