...
const h = d((A, e) => {
  var v = A, { children: a } = v, t = n(v, ["children"]);
  return /* @__PURE__ */ r.createElement(f, c({ ref: e }, t), a, /* @__PURE__ */ r.createElement(
    "path",
    {
