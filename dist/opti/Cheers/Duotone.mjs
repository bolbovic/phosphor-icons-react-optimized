...
var Z = (a, l, e) => l in a ? M(a, l, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[l] = e, A = (a, l) => {
  for (var e in l || (l = {}))
...
const d = i((t, e) => {
  var o = t, { children: a } = o, l = n(o, ["children"]);
  return /* @__PURE__ */ m.createElement(L, A({ ref: e }, l), a, /* @__PURE__ */ m.createElement(
    "path",
    {
