...
var r = (e, Z, a) => Z in e ? L(e, Z, { enumerable: !0, configurable: !0, writable: !0, value: a }) : e[Z] = a, c = (e, Z) => {
  for (var a in Z || (Z = {}))
    A.call(Z, a) && r(e, a, Z[a]);
  if (m)
    for (var a of m(Z))
      M.call(Z, a) && r(e, a, Z[a]);
  return e;
};
var p = (e, Z) => {
  var a = {};
  for (var t in e)
    A.call(e, t) && Z.indexOf(t) < 0 && (a[t] = e[t]);
  if (e != null && m)
    for (var t of m(e))
      Z.indexOf(t) < 0 && M.call(e, t) && (a[t] = e[t]);
  return a;
};
import l, { forwardRef as n } from "react";
import i from "../../lib/OptiBase.mjs";
const d = n((t, a) => {
  var o = t, { children: e } = o, Z = p(o, ["children"]);
  return /* @__PURE__ */ l.createElement(i, c({ ref: a }, Z), e, /* @__PURE__ */ l.createElement(
    "path",
    {
