...
var h = (a, H, e) => H in a ? n(a, H, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[H] = e, M = (a, H) => {
  for (var e in H || (H = {}))
    r.call(H, e) && h(a, e, H[e]);
  if (o)
    for (var e of o(H))
      p.call(H, e) && h(a, e, H[e]);
  return a;
};
var c = (a, H) => {
  var e = {};
...
const l = V((t, e) => {
  var Z = t, { children: a } = Z, H = c(Z, ["children"]);
