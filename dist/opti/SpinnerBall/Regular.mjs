...
var f = (e, t) => {
  var a = {};
  for (var r in e)
    Z.call(e, r) && t.indexOf(r) < 0 && (a[r] = e[r]);
  if (e != null && c)
    for (var r of c(e))
