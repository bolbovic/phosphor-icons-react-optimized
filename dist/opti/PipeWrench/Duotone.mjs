...
var m = (a, l, e) => l in a ? Z(a, l, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[l] = e, n = (a, l) => {
  for (var e in l || (l = {}))
...
const h = d((t, e) => {
  ...
  return /* @__PURE__ */ L.createElement(f, n({ ref: e }, l), a, /* @__PURE__ */ L.createElement(
    "path",
    {
