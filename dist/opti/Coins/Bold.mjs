...
var o = (a, e, c) => e in a ? s(a, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[e] = c, Z = (a, e) => {
  for (var c in e || (e = {}))
    r.call(e, c) && o(a, c, e[c]);
  if (C)
    for (var c of C(e))
      v.call(e, c) && o(a, c, e[c]);
  return a;
};
var V = (a, e) => {
  var c = {};
  ...
  if (a != null && C)
    for (var t of C(a))
      e.indexOf(t) < 0 && v.call(a, t) && (c[t] = a[t]);
  return c;
};
import p, { forwardRef as M } from "react";
import d from "../../lib/OptiBase.mjs";
const l = M((t, c) => {
  var m = t, { children: a } = m, e = V(m, ["children"]);
