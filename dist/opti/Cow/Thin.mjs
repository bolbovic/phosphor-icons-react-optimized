...
var h = (a, m, A) => m in a ? n(a, m, { enumerable: !0, configurable: !0, writable: !0, value: A }) : a[m] = A, o = (a, m) => {
  for (var A in m || (m = {}))
    r.call(m, A) && h(a, A, m[A]);
  if (t)
    for (var A of t(m))
      Z.call(m, A) && h(a, A, m[A]);
  return a;
};
var i = (a, m) => {
  var A = {};
  for (var e in a)
    r.call(a, e) && m.indexOf(e) < 0 && (A[e] = a[e]);
  if (a != null && t)
    for (var e of t(a))
      m.indexOf(e) < 0 && Z.call(a, e) && (A[e] = a[e]);
  return A;
};
