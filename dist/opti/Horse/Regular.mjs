...
var A = (a, r, e) => r in a ? s(a, r, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[r] = e, p = (a, r) => {
  for (var e in r || (r = {}))
    o.call(r, e) && A(a, e, r[e]);
  if (l)
    for (var e of l(r))
      c.call(r, e) && A(a, e, r[e]);
  return a;
};
var f = (a, r) => {
  var e = {};
