...
var r = (a, l, e) => l in a ? n(a, l, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[l] = e, h = (a, l) => {
  for (var e in l || (l = {}))
...
const d = L((t, e) => {
  var c = t, { children: a } = c, l = Z(c, ["children"]);
  return /* @__PURE__ */ m.createElement(i, h({ ref: e }, l), a, /* @__PURE__ */ m.createElement(
    "path",
    {
