...
var o = (a, c, e) => c in a ? i(a, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[c] = e, C = (a, c) => {
  for (var e in c || (c = {}))
    p.call(c, e) && o(a, e, c[e]);
  if (t)
    for (var e of t(c))
      A.call(c, e) && o(a, e, c[e]);
  return a;
};
var l = (a, c) => {
  var e = {};
