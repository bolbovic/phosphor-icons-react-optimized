...
var i = (e, t) => {
  ...
  if (e != null && o)
    for (var c of o(e))
      t.indexOf(c) < 0 && A.call(e, c) && (a[c] = e[c]);
  return a;
};
...
const l = f((c, a) => {
  ...
  return /* @__PURE__ */ r.createElement(h, n({ ref: a }, t), e, /* @__PURE__ */ r.createElement(
    "path",
    {
