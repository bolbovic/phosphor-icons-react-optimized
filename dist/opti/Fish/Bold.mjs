...
var o = (a, c, e) => c in a ? s(a, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[c] = e, d = (a, c) => {
  for (var e in c || (c = {}))
    r.call(c, e) && o(a, e, c[e]);
  if (l)
    for (var e of l(c))
...
var f = (a, c) => {
  var e = {};
  for (var t in a)
    r.call(a, t) && c.indexOf(t) < 0 && (e[t] = a[t]);
  if (a != null && l)
    for (var t of l(a))
