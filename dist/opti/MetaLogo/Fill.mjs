...
var l = (a, c, e) => c in a ? s(a, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[c] = e, i = (a, c) => {
  for (var e in c || (c = {}))
    m.call(c, e) && l(a, e, c[e]);
  if (r)
    for (var e of r(c))
