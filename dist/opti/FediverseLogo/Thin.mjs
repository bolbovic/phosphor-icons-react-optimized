...
var Z = (a, l, e) => l in a ? p(a, l, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[l] = e, M = (a, l) => {
  for (var e in l || (l = {}))
...
var c = (a, l) => {
  var e = {};
  for (var m in a)
    r.call(a, m) && l.indexOf(m) < 0 && (e[m] = a[m]);
  if (a != null && t)
    for (var m of t(a))
