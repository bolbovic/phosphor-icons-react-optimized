...
var r = (a, e, c) => e in a ? d(a, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[e] = c, s = (a, e) => {
  for (var c in e || (e = {}))
    l.call(e, c) && r(a, c, e[c]);
  if (m)
    for (var c of m(e))
      p.call(e, c) && r(a, c, e[c]);
  return a;
};
var A = (a, e) => {
  var c = {};
  for (var t in a)
    l.call(a, t) && e.indexOf(t) < 0 && (c[t] = a[t]);
  if (a != null && m)
    for (var t of m(a))
