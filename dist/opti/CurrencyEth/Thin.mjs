...
const h = s((m, a) => {
  var r = m, { children: e } = r, t = Z(r, ["children"]);
  return /* @__PURE__ */ c.createElement(d, n({ ref: a }, t), e, /* @__PURE__ */ c.createElement("path", { d: "M219.15,125.53l-88-112a4,4,0,0,0-6.3,0l-88,112a4,4,0,0,0,0,4.94l88,112a4,4,0,0,0,6.3,0l88-112A4,4,0,0,0,219.15,125.53ZM132,27.57l77.71,98.9L132,161.79Zm-8,134.22L46.29,126.47,124,27.57Zm0,8.79v57.85l-70.72-90Zm8,0,70.72-32.15-70.72,90Z" }));
});
h.displayName = "Thin";
export {
  h as Thin
