...
var r = (e, C, t) => C in e ? Z(e, C, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[C] = t, v = (e, C) => {
  for (var t in C || (C = {}))
    s.call(C, t) && r(e, t, C[t]);
  if (c)
    for (var t of c(C))
      o.call(C, t) && r(e, t, C[t]);
  return e;
};
var i = (e, C) => {
  var t = {};
  for (var a in e)
    s.call(e, a) && C.indexOf(a) < 0 && (t[a] = e[a]);
  if (e != null && c)
    for (var a of c(e))
      C.indexOf(a) < 0 && o.call(e, a) && (t[a] = e[a]);
  return t;
};
import p, { forwardRef as f } from "react";
import d from "../../lib/OptiBase.mjs";
const h = f((a, t) => {
  var m = a, { children: e } = m, C = i(m, ["children"]);
