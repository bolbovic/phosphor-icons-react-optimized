...
const E = n((r, a) => {
  ...
  return /* @__PURE__ */ s.createElement(h, c({ ref: a }, t), e, /* @__PURE__ */ s.createElement("path", { d: "M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm40,112H88a8,8,0,0,1,0-16h80a8,8,0,0,1,0,16Z" }));
});
E.displayName = "Fill";
export {
  E as Fill
