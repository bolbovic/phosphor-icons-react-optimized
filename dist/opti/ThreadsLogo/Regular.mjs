...
var C = (a, c, e) => c in a ? i(a, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[c] = e, s = (a, c) => {
  for (var e in c || (c = {}))
    o.call(c, e) && C(a, e, c[e]);
  if (t)
    for (var e of t(c))
      p.call(c, e) && C(a, e, c[e]);
  return a;
};
var l = (a, c) => {
  var e = {};
