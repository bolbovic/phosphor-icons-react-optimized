...
var C = (a, c, e) => c in a ? d(a, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[c] = e, l = (a, c) => {
  for (var e in c || (c = {}))
    o.call(c, e) && C(a, e, c[e]);
  if (r)
    for (var e of r(c))
      s.call(c, e) && C(a, e, c[e]);
  return a;
};
var p = (a, c) => {
  var e = {};
