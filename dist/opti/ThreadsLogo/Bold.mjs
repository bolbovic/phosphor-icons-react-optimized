...
var m = (a, c, e) => c in a ? f(a, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[c] = e, d = (a, c) => {
  for (var e in c || (c = {}))
...
var l = (a, c) => {
  var e = {};
  for (var t in a)
    p.call(a, t) && c.indexOf(t) < 0 && (e[t] = a[t]);
  if (a != null && o)
    for (var t of o(a))
