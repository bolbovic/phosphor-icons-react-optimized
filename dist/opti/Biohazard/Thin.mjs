...
var c = (a, m, e) => m in a ? s(a, m, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[m] = e, i = (a, m) => {
  for (var e in m || (m = {}))
    o.call(m, e) && c(a, e, m[e]);
  if (r)
    for (var e of r(m))
      Z.call(m, e) && c(a, e, m[e]);
  return a;
};
var p = (a, m) => {
  var e = {};
