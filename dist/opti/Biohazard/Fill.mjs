...
var r = (a, c, l) => c in a ? Z(a, c, { enumerable: !0, configurable: !0, writable: !0, value: l }) : a[c] = l, i = (a, c) => {
  for (var l in c || (c = {}))
    A.call(c, l) && r(a, l, c[l]);
  if (t)
    for (var l of t(c))
...
var p = (a, c) => {
  var l = {};
  for (var e in a)
    A.call(a, e) && c.indexOf(e) < 0 && (l[e] = a[e]);
  if (a != null && t)
    for (var e of t(a))
