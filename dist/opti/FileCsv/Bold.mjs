...
var A = (a, c, e) => c in a ? Z(a, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[c] = e, p = (a, c) => {
  for (var e in c || (c = {}))
    l.call(c, e) && A(a, e, c[e]);
  if (o)
    for (var e of o(c))
      m.call(c, e) && A(a, e, c[e]);
  return a;
};
var d = (a, c) => {
  var e = {};
