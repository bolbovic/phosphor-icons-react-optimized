...
var l = (a, c, e) => c in a ? s(a, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[c] = e, p = (a, c) => {
  for (var e in c || (c = {}))
    o.call(c, e) && l(a, e, c[e]);
  if (m)
    for (var e of m(c))
      i.call(c, e) && l(a, e, c[e]);
  return a;
};
var A = (a, c) => {
  var e = {};
