...
var r = (a, e, c) => e in a ? Z(a, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[e] = c, n = (a, e) => {
  for (var c in e || (e = {}))
    V.call(e, c) && r(a, c, e[c]);
  if (t)
    for (var c of t(e))
...
var C = (a, e) => {
  var c = {};
  for (var s in a)
    V.call(a, s) && e.indexOf(s) < 0 && (c[s] = a[s]);
  if (a != null && t)
    for (var s of t(a))
      e.indexOf(s) < 0 && p.call(a, s) && (c[s] = a[s]);
  return c;
};
import o, { forwardRef as i } from "react";
import d from "../../lib/OptiBase.mjs";
const f = i((s, c) => {
  var m = s, { children: a } = m, e = C(m, ["children"]);
  return /* @__PURE__ */ o.createElement(d, n({ ref: c }, e), a, /* @__PURE__ */ o.createElement(
    "path",
    {
