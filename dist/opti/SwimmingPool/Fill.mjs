...
var r = (a, s, c) => s in a ? Z(a, s, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[s] = c, i = (a, s) => {
  for (var c in s || (s = {}))
    l.call(s, c) && r(a, c, s[c]);
  if (t)
    for (var c of t(s))
      o.call(s, c) && r(a, c, s[c]);
  return a;
};
var p = (a, s) => {
  var c = {};
  for (var e in a)
    l.call(a, e) && s.indexOf(e) < 0 && (c[e] = a[e]);
  if (a != null && t)
    for (var e of t(a))
