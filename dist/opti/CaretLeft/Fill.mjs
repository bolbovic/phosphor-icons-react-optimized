...
const F = n((l, a) => {
  ...
  return /* @__PURE__ */ s.createElement(E, c({ ref: a }, t), e, /* @__PURE__ */ s.createElement("path", { d: "M168,48V208a8,8,0,0,1-13.66,5.66l-80-80a8,8,0,0,1,0-11.32l80-80A8,8,0,0,1,168,48Z" }));
});
F.displayName = "Fill";
export {
  F as Fill
