...
var o = (a, e, c) => e in a ? s(a, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[e] = c, p = (a, e) => {
  for (var c in e || (e = {}))
    C.call(e, c) && o(a, c, e[c]);
  if (r)
    for (var c of r(e))
