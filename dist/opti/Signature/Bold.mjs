...
var m = (a, c, e) => c in a ? f(a, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[c] = e, C = (a, c) => {
  for (var e in c || (c = {}))
    l.call(c, e) && m(a, e, c[e]);
  if (o)
    for (var e of o(c))
