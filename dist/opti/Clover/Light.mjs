...
var r = (a, e, c) => e in a ? Z(a, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[e] = c, A = (a, e) => {
  for (var c in e || (e = {}))
    m.call(e, c) && r(a, c, e[c]);
  if (C)
    for (var c of C(e))
...
var i = (a, e) => {
  var c = {};
  for (var t in a)
    m.call(a, t) && e.indexOf(t) < 0 && (c[t] = a[t]);
  if (a != null && C)
    for (var t of C(a))
...
const d = f((t, c) => {
  var s = t, { children: a } = s, e = i(s, ["children"]);
