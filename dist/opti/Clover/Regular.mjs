...
var t = (a, c, e) => c in a ? f(a, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[c] = e, p = (a, c) => {
  for (var e in c || (c = {}))
    m.call(c, e) && t(a, e, c[e]);
  if (r)
    for (var e of r(c))
