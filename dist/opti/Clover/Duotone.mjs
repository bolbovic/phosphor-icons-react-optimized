...
var n = (e, t) => {
  var a = {};
  for (var c in e)
    r.call(e, c) && t.indexOf(c) < 0 && (a[c] = e[c]);
  if (e != null && m)
    for (var c of m(e))
...
const f = S((c, a) => {
  var o = c, { children: e } = o, t = n(o, ["children"]);
  return /* @__PURE__ */ s.createElement(d, p({ ref: a }, t), e, /* @__PURE__ */ s.createElement(
    "path",
    {
