...
var m = (c, C, e) => C in c ? n(c, C, { enumerable: !0, configurable: !0, writable: !0, value: e }) : c[C] = e, i = (c, C) => {
  for (var e in C || (C = {}))
