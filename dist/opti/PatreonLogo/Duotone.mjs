...
var s = (e, a) => {
  ...
  if (e != null && o)
    for (var c of o(e))
      a.indexOf(c) < 0 && C.call(e, c) && (t[c] = e[c]);
  return t;
};
...
const E = f((c, t) => {
  ...
  return /* @__PURE__ */ r.createElement(l, i({ ref: t }, a), e, /* @__PURE__ */ r.createElement(
    "path",
    {
