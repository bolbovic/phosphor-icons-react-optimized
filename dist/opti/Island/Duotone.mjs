...
var p = (a, e, c) => e in a ? Z(a, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[e] = c, i = (a, e) => {
  for (var c in e || (e = {}))
    A.call(e, c) && p(a, c, e[c]);
  if (o)
    for (var c of o(e))
      n.call(e, c) && p(a, c, e[c]);
  return a;
};
var l = (a, e) => {
  var c = {};
  ...
  if (a != null && o)
    for (var t of o(a))
      e.indexOf(t) < 0 && n.call(a, t) && (c[t] = a[t]);
  return c;
};
