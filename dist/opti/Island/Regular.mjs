...
var A = (a, e, c) => e in a ? d(a, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[e] = c, p = (a, e) => {
  for (var c in e || (e = {}))
    o.call(e, c) && A(a, c, e[c]);
  if (r)
    for (var c of r(e))
      l.call(e, c) && A(a, c, e[c]);
  return a;
};
var f = (a, e) => {
  var c = {};
