...
const n = H((o, a) => {
  ...
  return /* @__PURE__ */ i.createElement(V, c({ ref: a }, t), e, /* @__PURE__ */ i.createElement("path", { d: "M200,36H56A20,20,0,0,0,36,56V200a20,20,0,0,0,20,20H200a20,20,0,0,0,20-20V56A20,20,0,0,0,200,36Zm-4,24v56H60V60ZM60,196V140H196v56Z" }));
});
n.displayName = "Bold";
export {
  n as Bold
