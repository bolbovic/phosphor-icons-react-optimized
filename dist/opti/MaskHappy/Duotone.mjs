...
var s = (e, a, t) => a in e ? Z(e, a, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[a] = t, C = (e, a) => {
  for (var t in a || (a = {}))
    p.call(a, t) && s(e, t, a[t]);
  if (o)
    for (var t of o(a))
      A.call(a, t) && s(e, t, a[t]);
  return e;
};
var n = (e, a) => {
  var t = {};
  for (var c in e)
    p.call(e, c) && a.indexOf(c) < 0 && (t[c] = e[c]);
  if (e != null && o)
    for (var c of o(e))
      a.indexOf(c) < 0 && A.call(e, c) && (t[c] = e[c]);
  return t;
};
import m, { forwardRef as i } from "react";
import d from "../../lib/OptiBase.mjs";
const f = i((c, t) => {
  var r = c, { children: e } = r, a = n(r, ["children"]);
  return /* @__PURE__ */ m.createElement(d, C({ ref: t }, a), e, /* @__PURE__ */ m.createElement(
    "path",
    {
