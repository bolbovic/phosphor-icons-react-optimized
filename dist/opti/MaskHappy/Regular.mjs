...
var s = (a, t, e) => t in a ? f(a, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[t] = e, l = (a, t) => {
  for (var e in t || (t = {}))
    o.call(t, e) && s(a, e, t[e]);
  if (c)
    for (var e of c(t))
      A.call(t, e) && s(a, e, t[e]);
  return a;
};
var p = (a, t) => {
  var e = {};
