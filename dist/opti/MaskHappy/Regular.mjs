...
var s = (e, r, a) => r in e ? Z(e, r, { enumerable: !0, configurable: !0, writable: !0, value: a }) : e[r] = a, p = (e, r) => {
  for (var a in r || (r = {}))
    o.call(r, a) && s(e, a, r[a]);
  if (c)
    for (var a of c(r))
      A.call(r, a) && s(e, a, r[a]);
  return e;
};
var C = (e, r) => {
  var a = {};
