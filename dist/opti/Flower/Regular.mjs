...
var A = (a, e, c) => e in a ? f(a, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[e] = c, l = (a, e) => {
  for (var c in e || (e = {}))
...
var p = (a, e) => {
  var c = {};
  for (var t in a)
    Z.call(a, t) && e.indexOf(t) < 0 && (c[t] = a[t]);
  if (a != null && r)
    for (var t of r(a))
      e.indexOf(t) < 0 && o.call(a, t) && (c[t] = a[t]);
  return c;
};
