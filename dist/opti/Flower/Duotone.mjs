...
var A = (a, e, c) => e in a ? C(a, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[e] = c, M = (a, e) => {
  for (var c in e || (e = {}))
    Z.call(e, c) && A(a, c, e[c]);
  if (o)
    for (var c of o(e))
      p.call(e, c) && A(a, c, e[c]);
  return a;
};
var n = (a, e) => {
  var c = {};
...
const f = i((t, c) => {
  ...
  return /* @__PURE__ */ m.createElement(d, M({ ref: c }, e), a, /* @__PURE__ */ m.createElement(
    "path",
    {
