...
var l = (a, e, L) => e in a ? c(a, e, { enumerable: !0, configurable: !0, writable: !0, value: L }) : a[e] = L, o = (a, e) => {
  for (var L in e || (e = {}))
    r.call(e, L) && l(a, L, e[L]);
  if (m)
    for (var L of m(e))
