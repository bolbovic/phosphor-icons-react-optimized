...
var m = (a, e, c) => e in a ? A(a, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[e] = c, n = (a, e) => {
  for (var c in e || (e = {}))
    p.call(e, c) && m(a, c, e[c]);
  if (o)
    for (var c of o(e))
      s.call(e, c) && m(a, c, e[c]);
  return a;
};
var i = (a, e) => {
  var c = {};
  ...
  if (a != null && o)
    for (var t of o(a))
      e.indexOf(t) < 0 && s.call(a, t) && (c[t] = a[t]);
  return c;
};
import r, { forwardRef as d } from "react";
import f from "../../lib/OptiBase.mjs";
const h = d((t, c) => {
  var l = t, { children: a } = l, e = i(l, ["children"]);
  return /* @__PURE__ */ r.createElement(f, n({ ref: c }, e), a, /* @__PURE__ */ r.createElement(
    "path",
    {
