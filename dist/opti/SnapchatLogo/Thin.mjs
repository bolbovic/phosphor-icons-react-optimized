...
var m = (a, e, c) => e in a ? A(a, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[e] = c, i = (a, e) => {
  for (var c in e || (e = {}))
    l.call(e, c) && m(a, c, e[c]);
  if (t)
    for (var c of t(e))
