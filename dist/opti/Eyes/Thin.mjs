...
var m = (a, s, e) => s in a ? Z(a, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[s] = e, i = (a, s) => {
  for (var e in s || (s = {}))
    r.call(s, e) && m(a, e, s[e]);
  if (c)
    for (var e of c(s))
...
var p = (a, s) => {
  var e = {};
  for (var t in a)
    r.call(a, t) && s.indexOf(t) < 0 && (e[t] = a[t]);
  if (a != null && c)
    for (var t of c(a))
