...
var r = (a, c, e) => c in a ? Z(a, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[c] = e, C = (a, c) => {
  for (var e in c || (c = {}))
    s.call(c, e) && r(a, e, c[e]);
  if (m)
    for (var e of m(c))
...
var d = (a, c) => {
  var e = {};
  for (var t in a)
    s.call(a, t) && c.indexOf(t) < 0 && (e[t] = a[t]);
  if (a != null && m)
    for (var t of m(a))
