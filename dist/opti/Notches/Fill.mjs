...
const F = n((r, a) => {
  ...
  return /* @__PURE__ */ s.createElement(E, c({ ref: a }, t), e, /* @__PURE__ */ s.createElement("path", { d: "M200,40V192a8,8,0,0,1-8,8H40a8,8,0,0,1-5.66-13.66l152-152A8,8,0,0,1,200,40Z" }));
});
F.displayName = "Fill";
export {
  F as Fill
