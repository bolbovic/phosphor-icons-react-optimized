...
var r = (c, e, s) => e in c ? i(c, e, { enumerable: !0, configurable: !0, writable: !0, value: s }) : c[e] = s, p = (c, e) => {
  for (var s in e || (e = {}))
...
var n = (c, e) => {
  var s = {};
  for (var t in c)
    C.call(c, t) && e.indexOf(t) < 0 && (s[t] = c[t]);
  if (c != null && a)
    for (var t of a(c))
...
const f = Z((t, s) => {
  var m = t, { children: c } = m, e = n(m, ["children"]);
