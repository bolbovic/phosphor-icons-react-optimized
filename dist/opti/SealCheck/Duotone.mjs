...
var C = (c, e, s) => e in c ? n(c, e, { enumerable: !0, configurable: !0, writable: !0, value: s }) : c[e] = s, p = (c, e) => {
  for (var s in e || (e = {}))
    m.call(e, s) && C(c, s, e[s]);
  if (a)
    for (var s of a(e))
      S.call(e, s) && C(c, s, e[s]);
  return c;
};
var l = (c, e) => {
  var s = {};
  for (var t in c)
    m.call(c, t) && e.indexOf(t) < 0 && (s[t] = c[t]);
  if (c != null && a)
    for (var t of a(c))
      e.indexOf(t) < 0 && S.call(c, t) && (s[t] = c[t]);
  return s;
};
import o, { forwardRef as i } from "react";
import d from "../../lib/OptiBase.mjs";
const f = i((t, s) => {
  var r = t, { children: c } = r, e = l(r, ["children"]);
  return /* @__PURE__ */ o.createElement(d, p({ ref: s }, e), c, /* @__PURE__ */ o.createElement(
    "path",
    {
