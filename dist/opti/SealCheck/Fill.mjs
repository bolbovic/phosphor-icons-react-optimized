...
var r = (c, a, e) => a in c ? f(c, a, { enumerable: !0, configurable: !0, writable: !0, value: e }) : c[a] = e, i = (c, a) => {
  for (var e in a || (a = {}))
    m.call(a, e) && r(c, e, a[e]);
  if (s)
    for (var e of s(a))
      o.call(a, e) && r(c, e, a[e]);
  return c;
};
var p = (c, a) => {
  var e = {};
  for (var t in c)
    m.call(c, t) && a.indexOf(t) < 0 && (e[t] = c[t]);
  if (c != null && s)
    for (var t of s(c))
...
const E = d((t, e) => {
  var l = t, { children: c } = l, a = p(l, ["children"]);
