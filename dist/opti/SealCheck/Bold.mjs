...
var r = (c, e, s) => e in c ? f(c, e, { enumerable: !0, configurable: !0, writable: !0, value: s }) : c[e] = s, m = (c, e) => {
  for (var s in e || (e = {}))
    C.call(e, s) && r(c, s, e[s]);
  if (t)
    for (var s of t(e))
      l.call(e, s) && r(c, s, e[s]);
  return c;
};
var p = (c, e) => {
  var s = {};
