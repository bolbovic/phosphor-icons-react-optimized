...
var r = (a, l, e) => l in a ? c(a, l, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[l] = e, o = (a, l) => {
  for (var e in l || (l = {}))
    t.call(l, e) && r(a, e, l[e]);
  if (m)
    for (var e of m(l))
...
var A = (a, l) => {
  var e = {};
  for (var Z in a)
    t.call(a, Z) && l.indexOf(Z) < 0 && (e[Z] = a[Z]);
  if (a != null && m)
    for (var Z of m(a))
