...
var s = (e, a) => {
  var t = {};
  for (var c in e)
    o.call(e, c) && a.indexOf(c) < 0 && (t[c] = e[c]);
  if (e != null && m)
    for (var c of m(e))
