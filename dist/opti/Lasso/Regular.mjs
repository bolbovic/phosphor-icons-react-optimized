...
var o = (a, c, e) => c in a ? i(a, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[c] = e, l = (a, c) => {
  for (var e in c || (c = {}))
    C.call(c, e) && o(a, e, c[e]);
  if (t)
    for (var e of t(c))
...
var S = (a, c) => {
  var e = {};
  for (var r in a)
    C.call(a, r) && c.indexOf(r) < 0 && (e[r] = a[r]);
  if (a != null && t)
    for (var r of t(a))
