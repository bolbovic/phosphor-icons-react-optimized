...
var r = (a, h, e) => h in a ? p(a, h, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[h] = e, H = (a, h) => {
  for (var e in h || (h = {}))
...
var Z = (a, h) => {
  var e = {};
  for (var t in a)
    c.call(a, t) && h.indexOf(t) < 0 && (e[t] = a[t]);
  if (a != null && A)
    for (var t of A(a))
