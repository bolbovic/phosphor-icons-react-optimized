...
var m = (c, e, s) => e in c ? C(c, e, { enumerable: !0, configurable: !0, writable: !0, value: s }) : c[e] = s, l = (c, e) => {
  for (var s in e || (e = {}))
    o.call(e, s) && m(c, s, e[s]);
  if (t)
    for (var s of t(e))
      S.call(e, s) && m(c, s, e[s]);
  return c;
};
var p = (c, e) => {
  var s = {};
  for (var a in c)
    o.call(c, a) && e.indexOf(a) < 0 && (s[a] = c[a]);
  if (c != null && t)
    for (var a of t(c))
