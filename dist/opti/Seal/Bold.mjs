...
var r = (c, e, s) => e in c ? f(c, e, { enumerable: !0, configurable: !0, writable: !0, value: s }) : c[e] = s, p = (c, e) => {
  for (var s in e || (e = {}))
    C.call(e, s) && r(c, s, e[s]);
  if (a)
    for (var s of a(e))
      m.call(e, s) && r(c, s, e[s]);
  return c;
};
var d = (c, e) => {
  var s = {};
