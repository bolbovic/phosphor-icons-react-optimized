...
var C = (c, e, s) => e in c ? i(c, e, { enumerable: !0, configurable: !0, writable: !0, value: s }) : c[e] = s, p = (c, e) => {
  for (var s in e || (e = {}))
...
const l = d((t, s) => {
  var r = t, { children: c } = r, e = n(r, ["children"]);
  return /* @__PURE__ */ o.createElement(f, p({ ref: s }, e), c, /* @__PURE__ */ o.createElement(
    "path",
    {
