...
var A = (a, e, l) => e in a ? h(a, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : a[e] = l, Z = (a, e) => {
  for (var l in e || (e = {}))
    p.call(e, l) && A(a, l, e[l]);
  if (o)
    for (var l of o(e))
...
const M = n((t, l) => {
  ...
  return /* @__PURE__ */ m.createElement(i, Z({ ref: l }, e), a, /* @__PURE__ */ m.createElement(
    "path",
    {
