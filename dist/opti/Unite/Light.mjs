...
var l = (a, e, A) => e in a ? p(a, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : a[e] = A, o = (a, e) => {
  for (var A in e || (e = {}))
    r.call(e, A) && l(a, A, e[A]);
  if (t)
    for (var A of t(e))
      c.call(e, A) && l(a, A, e[A]);
  return a;
};
var L = (a, e) => {
  var A = {};
