...
var p = (e, t, a) => t in e ? C(e, t, { enumerable: !0, configurable: !0, writable: !0, value: a }) : e[t] = a, i = (e, t) => {
  for (var a in t || (t = {}))
...
var l = (e, t) => {
  ...
  if (e != null && o)
    for (var c of o(e))
      t.indexOf(c) < 0 && n.call(e, c) && (a[c] = e[c]);
  return a;
};
import r, { forwardRef as d } from "react";
import f from "../../lib/OptiBase.mjs";
const Z = d((c, a) => {
  var m = c, { children: e } = m, t = l(m, ["children"]);
