...
var r = (c, s, a) => s in c ? S(c, s, { enumerable: !0, configurable: !0, writable: !0, value: a }) : c[s] = a, i = (c, s) => {
  for (var a in s || (s = {}))
    o.call(s, a) && r(c, a, s[a]);
  if (t)
    for (var a of t(s))
      Z.call(s, a) && r(c, a, s[a]);
  return c;
};
var p = (c, s) => {
  var a = {};
  for (var e in c)
    o.call(c, e) && s.indexOf(e) < 0 && (a[e] = c[e]);
  if (c != null && t)
    for (var e of t(c))
      s.indexOf(e) < 0 && Z.call(c, e) && (a[e] = c[e]);
  return a;
};
