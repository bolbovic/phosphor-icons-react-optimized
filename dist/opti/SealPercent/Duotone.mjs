...
var r = (c, e, s) => e in c ? n(c, e, { enumerable: !0, configurable: !0, writable: !0, value: s }) : c[e] = s, p = (c, e) => {
  for (var s in e || (e = {}))
    C.call(e, s) && r(c, s, e[s]);
  if (t)
    for (var s of t(e))
      S.call(e, s) && r(c, s, e[s]);
  return c;
};
var Z = (c, e) => {
  var s = {};
  for (var a in c)
    C.call(c, a) && e.indexOf(a) < 0 && (s[a] = c[a]);
  if (c != null && t)
    for (var a of t(c))
      e.indexOf(a) < 0 && S.call(c, a) && (s[a] = c[a]);
  return s;
};
import m, { forwardRef as i } from "react";
import l from "../../lib/OptiBase.mjs";
const d = i((a, s) => {
  var o = a, { children: c } = o, e = Z(o, ["children"]);
  return /* @__PURE__ */ m.createElement(l, p({ ref: s }, e), c, /* @__PURE__ */ m.createElement(
    "path",
    {
