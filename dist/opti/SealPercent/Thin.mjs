...
var r = (c, a, s) => a in c ? f(c, a, { enumerable: !0, configurable: !0, writable: !0, value: s }) : c[a] = s, i = (c, a) => {
  for (var s in a || (a = {}))
    o.call(a, s) && r(c, s, a[s]);
  if (m)
    for (var s of m(a))
      Z.call(a, s) && r(c, s, a[s]);
  return c;
};
var p = (c, a) => {
  var s = {};
