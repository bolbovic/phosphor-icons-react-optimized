...
var p = (a, c) => {
  var e = {};
  for (var s in a)
    l.call(a, s) && c.indexOf(s) < 0 && (e[s] = a[s]);
  if (a != null && t)
    for (var s of t(a))
