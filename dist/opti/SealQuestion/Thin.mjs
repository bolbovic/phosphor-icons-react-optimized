...
var r = (c, a, s) => a in c ? S(c, a, { enumerable: !0, configurable: !0, writable: !0, value: s }) : c[a] = s, p = (c, a) => {
  for (var s in a || (a = {}))
    o.call(a, s) && r(c, s, a[s]);
  if (t)
    for (var s of t(a))
      i.call(a, s) && r(c, s, a[s]);
  return c;
};
var n = (c, a) => {
  var s = {};
