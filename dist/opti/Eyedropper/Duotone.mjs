...
var m = (a, e, l) => e in a ? f(a, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : a[e] = l, i = (a, e) => {
  for (var l in e || (e = {}))
    p.call(e, l) && m(a, l, e[l]);
  if (o)
    for (var l of o(e))
      n.call(e, l) && m(a, l, e[l]);
  return a;
};
var d = (a, e) => {
  var l = {};
  ...
  if (a != null && o)
    for (var t of o(a))
      e.indexOf(t) < 0 && n.call(a, t) && (l[t] = a[t]);
  return l;
};
import r, { forwardRef as s } from "react";
import A from "../../lib/OptiBase.mjs";
const L = s((t, l) => {
  var c = t, { children: a } = c, e = d(c, ["children"]);
  return /* @__PURE__ */ r.createElement(A, i({ ref: l }, e), a, /* @__PURE__ */ r.createElement(
    "path",
    {
