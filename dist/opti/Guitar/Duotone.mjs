...
var M = (a, t) => {
  var e = {};
  for (var c in a)
    Z.call(a, c) && t.indexOf(c) < 0 && (e[c] = a[c]);
  if (a != null && o)
    for (var c of o(a))
