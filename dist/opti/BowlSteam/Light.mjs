...
var A = (a, e, c) => e in a ? h(a, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[e] = c, p = (a, e) => {
  for (var c in e || (e = {}))
    o.call(e, c) && A(a, c, e[c]);
  if (m)
    for (var c of m(e))
      i.call(e, c) && A(a, c, e[c]);
  return a;
};
var Z = (a, e) => {
  var c = {};
