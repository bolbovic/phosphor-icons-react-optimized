...
var A = (e, r, a) => r in e ? i(e, r, { enumerable: !0, configurable: !0, writable: !0, value: a }) : e[r] = a, p = (e, r) => {
  for (var a in r || (r = {}))
    o.call(r, a) && A(e, a, r[a]);
  if (m)
    for (var a of m(r))
      l.call(r, a) && A(e, a, r[a]);
  return e;
};
var s = (e, r) => {
  var a = {};
