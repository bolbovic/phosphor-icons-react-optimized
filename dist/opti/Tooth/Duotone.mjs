...
var A = (e, a, t) => a in e ? h(e, a, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[a] = t, n = (e, a) => {
  for (var t in a || (a = {}))
    p.call(a, t) && A(e, t, a[t]);
  if (c)
    for (var t of c(a))
      s.call(a, t) && A(e, t, a[t]);
  return e;
};
var C = (e, a) => {
  var t = {};
...
const d = i((o, t) => {
  ...
  return /* @__PURE__ */ m.createElement(l, n({ ref: t }, a), e, /* @__PURE__ */ m.createElement(
    "path",
    {
