...
var r = (e, a, t) => a in e ? Z(e, a, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[a] = t, A = (e, a) => {
  for (var t in a || (a = {}))
...
var n = (e, a) => {
  var t = {};
  for (var s in e)
    C.call(e, s) && a.indexOf(s) < 0 && (t[s] = e[s]);
  if (e != null && c)
    for (var s of c(e))
      a.indexOf(s) < 0 && p.call(e, s) && (t[s] = e[s]);
  return t;
};
import o, { forwardRef as i } from "react";
import d from "../../lib/OptiBase.mjs";
const f = i((s, t) => {
  var m = s, { children: e } = m, a = n(m, ["children"]);
  return /* @__PURE__ */ o.createElement(d, A({ ref: t }, a), e, /* @__PURE__ */ o.createElement(
    "path",
    {
