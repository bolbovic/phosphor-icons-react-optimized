...
var m = (a, s, e) => s in a ? f(a, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[s] = e, C = (a, s) => {
  for (var e in s || (s = {}))
    o.call(s, e) && m(a, e, s[e]);
  if (r)
    for (var e of r(s))
      A.call(s, e) && m(a, e, s[e]);
  return a;
};
var l = (a, s) => {
  var e = {};
