...
var r = (e, t, c) => t in e ? M(e, t, { enumerable: !0, configurable: !0, writable: !0, value: c }) : e[t] = c, A = (e, t) => {
  for (var c in t || (t = {}))
    Z.call(t, c) && r(e, c, t[c]);
  if (v)
    for (var c of v(t))
      p.call(t, c) && r(e, c, t[c]);
  return e;
};
var C = (e, t) => {
  var c = {};
  for (var a in e)
    Z.call(e, a) && t.indexOf(a) < 0 && (c[a] = e[a]);
  if (e != null && v)
    for (var a of v(e))
      t.indexOf(a) < 0 && p.call(e, a) && (c[a] = e[a]);
  return c;
};
import o, { forwardRef as V } from "react";
import n from "../../lib/OptiBase.mjs";
const i = V((a, c) => {
  var m = a, { children: e } = m, t = C(m, ["children"]);
  return /* @__PURE__ */ o.createElement(n, A({ ref: c }, t), e, /* @__PURE__ */ o.createElement(
    "path",
    {
