...
var h = (a, c, e) => c in a ? s(a, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[c] = e, i = (a, c) => {
  for (var e in c || (c = {}))
    o.call(c, e) && h(a, e, c[e]);
  if (r)
    for (var e of r(c))
      A.call(c, e) && h(a, e, c[e]);
  return a;
};
var l = (a, c) => {
  var e = {};
