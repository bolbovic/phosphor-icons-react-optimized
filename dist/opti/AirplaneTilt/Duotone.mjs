...
var p = (l, e, a) => e in l ? i(l, e, { enumerable: !0, configurable: !0, writable: !0, value: a }) : l[e] = a, c = (l, e) => {
  for (var a in e || (e = {}))
    A.call(e, a) && p(l, a, e[a]);
  if (o)
    for (var a of o(e))
      L.call(e, a) && p(l, a, e[a]);
  return l;
};
var n = (l, e) => {
  var a = {};
  for (var t in l)
    A.call(l, t) && e.indexOf(t) < 0 && (a[t] = l[t]);
  if (l != null && o)
    for (var t of o(l))
      e.indexOf(t) < 0 && L.call(l, t) && (a[t] = l[t]);
  return a;
};
import r, { forwardRef as d } from "react";
import f from "../../lib/OptiBase.mjs";
const s = d((t, a) => {
  var m = t, { children: l } = m, e = n(m, ["children"]);
  return /* @__PURE__ */ r.createElement(f, c({ ref: a }, e), l, /* @__PURE__ */ r.createElement(
    "path",
    {
