...
var r = (a, e, c) => e in a ? p(a, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[e] = c, Z = (a, e) => {
  for (var c in e || (e = {}))
...
var i = (a, e) => {
  var c = {};
  for (var s in a)
    C.call(a, s) && e.indexOf(s) < 0 && (c[s] = a[s]);
  if (a != null && t)
    for (var s of t(a))
