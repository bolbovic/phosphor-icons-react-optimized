...
var t = (a, c, e) => c in a ? M(a, c, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[c] = e, o = (a, c) => {
  for (var e in c || (c = {}))
    l.call(c, e) && t(a, e, c[e]);
  if (r)
    for (var e of r(c))
