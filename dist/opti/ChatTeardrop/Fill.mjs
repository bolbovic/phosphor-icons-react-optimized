...
const F = n((r, a) => {
  ...
  return /* @__PURE__ */ s.createElement(E, c({ ref: a }, t), e, /* @__PURE__ */ s.createElement("path", { d: "M232,124A100.11,100.11,0,0,1,132,224H48a16,16,0,0,1-16-16V124a100,100,0,0,1,200,0Z" }));
});
F.displayName = "Fill";
export {
  F as Fill
